...
class DeliveryDetailSerializer(serializers.ModelSerializer):
    ...
    location_logs = DeliveryLocationLogSerializer(many=True, read_only=True)
    ...
    class Meta:
        ...
        fields = ['id', 'order', 'order_number', 'pharmacy_name', 'pharmacy_phone',
                  ...
                  'location_logs', 'note', 'created_at', 'updated_at']
...
class CourierLocationSerializer(serializers.Serializer):
    ...
    bearing = serializers.FloatField(required=False)
